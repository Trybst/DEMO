...
- (void)setupHistoryHeaderView {
    ...
    _tagView = ({
        ...
        UICollectionView *tagView = [[UICollectionView alloc] initWithFrame:CGRectMake(12, 44, kScreenWidth-24, 100) collectionViewLayout:layout];
...
- (NSArray *)randomTagArray {
    ...
    dispatch_once(&onceToken, ^{
        ...
        sourceTag = @[@"辰东",@"我吃西红柿",@"唐家三少",@"天蚕土豆",@"耳根",@"烟雨江南",@"梦入神机",@"骷髅精灵",@"完美世界",@"大主宰",@"斗破苍穹",@"斗罗大陆",@"如果蜗牛有爱情",@"极品家丁",@"择天记",@"神墓",@"遮天",@"太古神王",@"帝霸",@"校花的贴身高手",@"武动乾坤",@"一念永恒"];
    });
