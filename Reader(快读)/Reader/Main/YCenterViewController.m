...
@interface YCenterViewController ()<UITableViewDelegate,UITableViewDataSource,GADBannerViewDelegate>
...
- (void)viewDidLoad {
    ...
    self.titleLbl.font = [UIFont fontWithName:@"FZMWJW--GB1-0" size:19.0];
    
    self.booksTableView.contentInset = UIEdgeInsetsMake(0, 0, 34, 0);
//    [self setBanner];
}
...
- (UIView *)tableView:(UITableView *)tableView viewForFooterInSection:(NSInteger)section {
    UIView *footerV = [[UIView alloc] initWithFrame:CGRectMake(0, 0, tableView.width, 100)];
//    view.backgroundColor = YRGBColor(235, 235, 235);
    ...
    UILabel *label = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, 250, view.height)];
    label.textAlignment = NSTextAlignmentCenter;
    label.centerX = view.centerX + 10;
    label.text = @"添加您喜欢的小说";
    ...
    imageV.centerX = view.centerX - 80;
...
//- (void)setBanner {
//    self.bannerView = [[GADBannerView alloc] initWithFrame:CGRectMake(0, kScreenHeight - 49, kScreenWidth, 49)];
...
- (IBAction)tapAction:(id)sender {
    ...
    YShowState state = button.tag == 100 ? YShowStateMenu : YShowStateRight;
