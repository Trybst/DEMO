...
- (void)viewDidLoad {
    ...
    _testArr = @[@"搜索",@"分类",@"排行榜"];
    _imageArr = @[@"rsm_icon_0",@"rsm_icon_5",@"rsm_icon_3"];
...
//    BOOL isShow = [[NSUserDefaults standardUserDefaults] boolForKey:@"is_show"];
//    if (isShow) {
//        _testArr = @[@"搜索",@"排行榜",@"18岁禁區"];
//        _imageArr = @[@"rsm_icon_0",@"rsm_icon_3",@"rsm_icon_1"];
//    }
