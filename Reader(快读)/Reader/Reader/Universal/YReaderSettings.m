...
@property (strong, nonatomic) NSArray *fontNameArr;
...
//        _font = [UIFont systemFontOfSize:_fontSize];
        ...
        _font = _idxFont > 0 ? [UIFont fontWithName:_fontNameArr[_idxFont] size:_fontSize] : [UIFont systemFontOfSize:_fontSize];
...
//        _font = [UIFont systemFontOfSize:fontSize];
        _idxFont = (int)[[NSUserDefaults standardUserDefaults] integerForKey:@"idxFont"];
        _font = _idxFont > 0 ? [UIFont fontWithName:_fontNameArr[_idxFont] size:fontSize] : [UIFont systemFontOfSize:fontSize];
        _needUpdateAttributes = YES;
        [self updateReaderSettings];
    }
}
...
- (NSArray *)fontNameArr {
    if (!_fontNameArr) {
        _fontNameArr = @[@"", @"STKaiti", @"FZMWJW--GB1-0"];
    }
    return _fontNameArr;
}
